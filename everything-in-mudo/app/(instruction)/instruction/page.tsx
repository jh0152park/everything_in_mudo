...
export default function Instruction() {
    return (
        <main className="flex flex-col items-center justify-center w-full h-screen p-5">
            <div className="flex items-center justify-center w-full gap-4 h-1/4 text-[13px] sm:text-xl">
                <div className="flex flex-col items-end justify-center w-1/2 h-full font-bold">
                    <span>? ! . ,와 같은 문장기호는 X</span>
                    <span>하지만 공백은 포함!</span>
                    <span>문제 순서는 랜덤!</span>
                </div>
                <div className=" w-[1px] h-full border border-[#7f7377]" />
                <div className="flex flex-col items-start justify-center w-1/2 h-full font-bold">
